                    ...
                    <div className="col-lg-6">
                        <div className="mb-5 mb-lg-0 text-center text-lg-start">
                            ...
                            <p className="lead fw-normal text-muted mb-5">
                                We are passionate about books and dedicated to helping you discover your next great read. Our app offers a vast collection of books across various genres, ensuring there's something for everyone.
                            </p>
                            <p className="lead fw-normal text-muted mb-5">
